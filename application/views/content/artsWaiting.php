...
<?php foreach ($artList as $artList): ?>
  <div class="o-wrapper">
    <div class="c-movie-card">
      <div class="c-movie-card__img" style="background-image: url('<?php echo base_url(); ?>uploads/images/art/waiting/<?php echo $artList->type1imagefilename; ?>');"></div>
      ...
      <span class="c-icons__arow">
        ...
        <a href="<?php echo base_url()?><?php echo $artList->category ?>/waiting/<?php echo $artList->id ?>">
          <svg version="1.1"
          viewBox="0 0 28.6 8">
          <style type="text/css">
          .st0{fill:#E5E5E5;}
